...
// 2022. The C++ twin of `shipvision/mot/trackers/botsort/tracker.py`, and — like the Python —
...
// `shipvision.mot.motion.cmc` — a PTZ head's own encoder beats any estimate made from
