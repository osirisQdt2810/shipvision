...
//
// A port of `shipvision/tracking/pool.py`, and the reason it is shared there is the reason it
...
//   lives in `shipvision.tracking.base.next_track_id`. The wrapper maps local to global once
//   per birth.
...
#include "shipvision/tracking/kalman.h"
