...
#: :mod:`shipvision.mot.registry`; listing it here keeps every
#: ``from shipvision.mot.base import TRACKERS`` in the wild resolving. Do not move the
...
class BaseTracker(abc.ABC):
    ...
    Subclasses build the :class:`~shipvision.mot.pool.TrackPool` they want and hand it
