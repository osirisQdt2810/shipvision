...
policy decision and it belongs in :mod:`shipvision.mot`, which owns the public surface,
...
:mod:`shipvision.mot.core`, because the algorithm and the backend are different axes: the
...
:mod:`~shipvision.mot.backends.native`
