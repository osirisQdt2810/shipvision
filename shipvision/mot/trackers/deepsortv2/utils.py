...
:mod:`shipvision.mot.association.costs`, "is there any appearance evidence" in
:func:`~shipvision.mot.association.appearance.pairwise_appearance` (BoT-SORT needs it
too), and the dynamic-rate rule itself in
:func:`~shipvision.mot.association.appearance.dynamic_appearance_momentum`.
"""
...
def dynamic_momentum(
    ...
    of rates. :meth:`~shipvision.mot.pool.TrackPool.apply_matches` reads it as "use the
