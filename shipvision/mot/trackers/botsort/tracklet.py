...
:meth:`~shipvision.mot.pool.TrackPool.apply_camera_motion` warps the predictions once per
frame, and :meth:`~shipvision.mot.pool.TrackPool.embeddings` reads the appearance vectors
