...
The primitives the costs compose (:func:`~shipvision.mot.association.costs.iou_cost`,
:func:`~shipvision.mot.association.costs.fuse_score`,
:func:`~shipvision.mot.association.costs.gate_cost`) are shared and stay in
``association/``.
"""
...
from shipvision.mot.association import fuse_score, gate_cost, gated_iou_cost, iou_cost
...
def low_score_cost(
    ...
    *,
    ...
    :func:`shipvision.mot.trackers.sort.utils.association_cost`, so both delegate to the one
