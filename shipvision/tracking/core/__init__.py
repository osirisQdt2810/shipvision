...
``tracklet.py``
    ...
    *class* here and that is deliberate — see :mod:`shipvision.tracking.core.sort.tracklet`
    for the reason — so what the file states is which of
    :class:`~shipvision.tracking.pool.TrackPool`'s optional capabilities the algorithm turns
...
``utils.py``
    ...
    :mod:`shipvision.tracking.association` or :mod:`shipvision.tracking.motion` instead of
...
from shipvision.tracking.core.botsort import BotSortTracker
from shipvision.tracking.core.bytetrack import ByteTrackTracker
from shipvision.tracking.core.deepsortv2 import DeepSortV2Tracker
from shipvision.tracking.core.ocsort import OcSortTracker
from shipvision.tracking.core.sort import SortTracker
