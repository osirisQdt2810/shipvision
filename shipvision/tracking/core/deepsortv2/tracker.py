...
The four costs themselves live in :mod:`shipvision.tracking.core.deepsortv2.utils`, so that
...
class DeepSortV2Tracker(BaseTracker):
    ...
    def _recoverable(self, rows: list[int], detections: Detections) -> list[int]:
        ...
        :func:`~shipvision.tracking.core.deepsortv2.utils.off_border` where it can be tested
