...
The primitives are shared — :func:`~shipvision.tracking.association.costs.min_fuse` is where
the fusion rule lives and :func:`~shipvision.tracking.association.appearance.pairwise_appearance`
...
from shipvision.tracking.association import gate_cost, iou_cost, min_fuse
