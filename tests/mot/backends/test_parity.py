...
tolerance — see :func:`~tests.mot.backends.conftest.assert_same_tracking`. Track ids are
...
from tests.mot.backends.conftest import NATIVE_BUILT, NO_BUILD, assert_same_tracking
from tests.mot.conftest import CAMERA, box, det, drive, frame
