...
:mod:`shipvision.mot.trackers.deepsortv2.tracker` for the four defects found and not carried
over.
"""
...
class TestAppearance:
    ...
    def test_a_wrong_appearance_is_vetoed_rather_than_outvoted(self) -> None:
        ...
        from shipvision.mot.association import appearance_cost
    ...
    def test_the_dynamic_appearance_rate_slows_down_in_a_crowd(self) -> None:
        ...
        The rule is tested directly in ``tests/mot/association/test_appearance.py``; what
