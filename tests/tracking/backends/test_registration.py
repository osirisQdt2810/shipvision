...
from shipvision.tracking.backends import native
...
from tests.tracking.backends.conftest import NATIVE_BUILT, NO_BUILD
...
class TestTheRegistryStatesWhatTheLibraryImplements:
    ...
    def test_no_compiled_tracker_is_registered_without_its_oracle(self) -> None:
        ...
        ``tests/tracking/backends/test_parity.py`` enumerates from the registry, so a compiled
...
class TestResolutionWhenThereIsNoBuild:
    ...
    def test_asking_for_a_backend_nobody_implements_still_lists_what_there_is(self) -> None:
        ...
        from shipvision.tracking.motion.cmc import CAMERA_MOTION
