...
class TestTheDefaultParametersReproduceClassic:
    def test_the_default_parameters_reproduce_classic(self, ops) -> None:
    ...
    def test_a_box_nothing_corroborates_is_dropped(self, ops) -> None:
    ...
    def test_a_cluster_whose_scores_do_not_add_up_is_dropped(self, ops) -> None:
